		...
		<div class="breadcrumbs-v4">
			<div class="container">
				...
				<ul class="breadcrumb-v4-in">
					...
					<li class="active"><a href="${pageContext.request.contextPath }/product/list">Sản phẩm</a></li>
				</ul>
			</div>
			<!--/end container-->
		</div>
							...
							<div class="row">
								...
								<div class="col-sm-8 product-description">
									...
									<div class="overflow-h margin-bottom-5">
										...
										<a href="${pageContext.request.contextPath }/product/detail?id=${p.id}" ><button type="button" class="btn-u btn-u-sea-shop">Mua ngay</button></a>
									</div>
